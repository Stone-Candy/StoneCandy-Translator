...
- 下载 [`step1-first-install.bat`](https://github.com/hgmzhn/manga-translator-ui/raw/main/step1-first-install.bat)
- 保存到你想安装程序的目录（如 `D:\manga-translator-ui\`）

#### 2. 运行安装脚本

双击 `step1-first-install.bat`，脚本会：
...
├── step1-first-install.bat            # 安装脚本
├── step2-launch-qt.bat          # 启动脚本
├── step3-update-and-launch.bat      # 更新并启动
├── step4-maintenance.bat            # 维护工具
...
双击 `step2-launch-qt.bat`

> **提示**：也可以双击 `step3-update-and-launch.bat` 在启动前自动检查更新

#### 4. 更新程序（可选）

需要更新到最新版本时：

双击 `step4-maintenance.bat`，选择"完整更新"
...
| 脚本文件 | 说明 | 对应 Windows |
|---------|------|-------------|
| `macOS_1_首次安装.sh` | 首次环境配置、代码克隆、Miniforge 安装、依赖安装 | step1-first-install.bat |
| `macOS_2_启动Qt界面.sh` | 启动图形界面 | step2-launch-qt.bat |
| `macOS_3_检查更新并启动.sh` | 检查版本更新后启动 | step3-update-and-launch.bat |
| `macOS_4_更新维护.sh` | 运行维护菜单（更新代码、更新依赖、清理缓存等） | step4-maintenance.bat |

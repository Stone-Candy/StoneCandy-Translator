...
a = Analysis(
    ...
    datas=py3langid_datas + unidic_datas + pythainlp_datas + nlpo3_datas + onnx_datas + opencc_datas + [
        ('../desktop_qt_ui/ui/icons', 'desktop_qt_ui/ui/icons'),
        ('../desktop_qt_ui/ui/main_page/settings_tab_layout.json', 'desktop_qt_ui/ui/main_page'),
    ],  # 添加所有数据文件
    hiddenimports=[
        'pydensecrf.eigen', 
        'bsdiff4.core', 

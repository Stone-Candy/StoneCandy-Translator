...
만화 이미지 속 글자를 한 번에 번역합니다. 일본 만화, 한국 웹툰, 서양 코믹스는 물론 흑백·컬러 페이지를 모두 인식할 수 있습니다. 텍스트 검출, OCR, 번역, 인페인팅, 식자를 자동으로 처리하며, 텍스트 상자를 조정할 수 있는 시각 편집기가 내장되어 있습니다.

<img title="" src="doc/images/PPL24.png">  **StoneCandy** 

...
<div align="center">
속도와, 편의성, 접근성을 모두 극대화하고자 조정된 만화 번역기입니다. <br>
 
**유료 AI 구독 없이도 딸깍 번역이 가능한 만화 번역기!!** **_(TXT 모드)_** <br>
한글 배치에 최적화된 알고리즘을 제공하며, 클릭 몇 번으로 출판급 퀄리티에 가까운 결과물을 낼 수 있도록 UI가 마련되어 있습니다.<br>
또한 여러 가지 편의기능이 마련되어 있습니다. 
<br>
...
**[StoneCandy-Translator 0.9 Release](https://github.com/Stone-Candy/StoneCandy-Translator/releases)**
<br>
<br>
...
<img title="" src="doc/images/sample_01.png"> 
...
5. 글꼴과 스타일은 ctrl + [숫자키] 로 저장되며, 같은 숫자키를 누르면 글자 레이어에 저장된 스타일을 적용시킬 수 있습니다. 앱을 껐다 켜게 되면 단축키 설정이 사라지지만, 스타일을 저장할 때 앞에 숫자를 붙이면 앱을 열 때 해당 숫자에 자동으로 단축키가 할당됩니다.
6. 배포 가능한 폰트를 몇 개를 포함하였습니다. 설정 - 조판 에서 시스템 폰트 사용 여부를 결정할 수 있습니다.
7. 지우개 선택 상태에서 ctrl+클릭 하게되면 연결된 영역을 클릭 한번으로 삭제 가능해집니다. <img title="" src="doc/images/rmv_area.png"> 

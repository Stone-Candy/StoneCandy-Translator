...
class DocumentSnapshot:
    ...
    # 결과 이미지를 translation_map으로 열었을 때, 다시 내보낼 폴더
    preferred_export_dir: Optional[str] = None
...
class EditorSession:
    ...
    def __init__(self, resource_manager: ResourceManager):
        ...
        self._preferred_export_dir: Optional[str] = None
        self._image = None
    ...
    def set_preferred_export_dir(self, path: Optional[str]) -> None:
        self._preferred_export_dir = path

    def get_preferred_export_dir(self) -> Optional[str]:
        return self._preferred_export_dir
    ...
    def set_display_mask_type(self, mask_type: str) -> bool:
        if mask_type not in {"raw", "refined", "paint", "none"}:
            return False
    ...
    def load_document(self, snapshot: DocumentSnapshot) -> None:
        ...
        self.set_preferred_export_dir(getattr(snapshot, "preferred_export_dir", None))
    ...
    def clear_document(self) -> None:
        ...
        self.set_preferred_export_dir(None)
        self.set_image(None)

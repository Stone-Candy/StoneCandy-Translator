...
class ReplacementsEditorPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        filter_row_layout.setContentsMargins(0, 2, 0, 0)
        ...
        for group_key, group_label in [
            ...
            page = QWidget()
            page.setObjectName("replacements_tab_page")
            page_layout = QVBoxLayout(page)
            page_layout.setContentsMargins(0, 4, 0, 0)
            page_layout.setSpacing(0)
            page_layout.addWidget(table)
            self._tab_widget.addTab(page, group_label)
    ...
    def _create_table(self) -> QTableWidget:
        ...
        table.setStyleSheet(table_stylesheet(editable=True, border_radius=0))

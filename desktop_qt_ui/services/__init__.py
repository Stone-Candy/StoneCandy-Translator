...
class ServiceContainer:
    ...
    def _init_essential_services(self):
        ...
        self.logger.info("Essential services initialized")
    ...
    def _init_heavy_services(self):
        ...
        try:
            ...
            self.logger.info("Background heavy services initialized")
            
        except Exception as e:
            self.logger.error(f"Failed to initialize background heavy services: {e}")
    ...
    def _call_service_hook(self, service_name: str, *hook_names: str):
        ...
        self.logger.debug(f"Service {service_name} has no shutdown hook among: {hook_names}")
